...
static const u16 sSpeciesToHoennPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_HOENN(DUCKLIN),
    SPECIES_TO_HOENN(DAVID_SPADE),
};
...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(DUCKLIN),
    SPECIES_TO_NATIONAL(DAVID_SPADE),
};
...
static const u16 sHoennToNationalOrder[HOENN_DEX_COUNT - 1] =
{
    ...
    HOENN_TO_NATIONAL(DUCKLIN),
    HOENN_TO_NATIONAL(DAVID_SPADE),
};
...
static const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DUCKLIN - 1]       = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_DAVID_SPADE - 1]   = ANIM_V_SQUISH_AND_BOUNCE,
...
void CreateBoxMon(struct BoxPokemon *boxMon, u16 species, u8 level, u8 fixedIV, u8 hasFixedPersonality, u32 fixedPersonality, u8 otIdType, u32 fixedOtId)
{
    ...
    else // Player is the OT
    {
        ...
        u32 shinyRolls = (CheckBagHasItem(ITEM_SHINY_CHARM, 1)) ? I_SHINY_CHARM_REROLLS : 1;
        #else
        u32 shinyRolls = 1;
        #endif
        u32 i;
